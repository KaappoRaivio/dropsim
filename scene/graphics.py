...
class Graphics:
    ...
    def fillObject(self, _scene: scene.Scene, _object: object.Object):
        ...
        self.display.blit(text1, (position_in_pixels[0] + _object.sprite.size[0], min(position_in_pixels[1] - 50, self.size[1])))
        self.display.blit(text2, (position_in_pixels[0] + _object.sprite.size[0], min(position_in_pixels[1] - 25, self.size[1])))
        self.display.blit(text3, (position_in_pixels[0] + _object.sprite.size[0], min(position_in_pixels[1] - 0, self.size[1])))
