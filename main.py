...
# ball = object.Object("assets/ball.png", reverse=True, pos=(-0.02, 5), air_resistance=False)  # TODO
# ball2 = object.Object("assets/ball.png", reverse=True, pos=(0.01, 5), C=1)  # TODO
# while True:
...
for filename in sys.argv[1:]:
    objects.append(eval(open(filename, 'r').readline()))
